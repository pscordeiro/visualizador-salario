...
![Main dashboard with salary evolution, gross vs net, yearly summary and tax distribution charts](imgs/dash-geral.jpeg)

| Files | Holerite Detail |
|---|---|
| ![File upload and management screen](imgs/meus-arquivos.jpeg) | ![Expanded holerite showing all line items](imgs/detalhe-holerite.jpeg) |

| Tax Details | Login |
|---|---|
| ![Detailed tax table per period with INSS and IRRF totals](imgs/detalhe-imposto.jpeg) | ![Login screen](imgs/login.jpeg) |
